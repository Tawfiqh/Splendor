...
FE - information architecture:
    ...
    - ✅ Show how many gems you have total next to "Your gems"
...
Fe Advanced style:
    ...
    - Add unsplahs images from a mapping between cards


BE:
    - Host with board-game.io 
    - enable local P2P
    - Setup a BE for matchmaking and game management
